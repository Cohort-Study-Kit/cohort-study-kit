...
"./js/educational_institution_overview/index.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  EducationalInstitutionOverview: function() { return EducationalInstitutionOverview; }
});
...
class EducationalInstitutionOverview {
  constructor() {
    this.el = false
    this.copsacId = false
    this.institutions = []
  ...
  getInstitutions() {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getJson)(`/api/educational_institution/get/${this.copsacId}/`).then(
      ({ json }) => {
        this.institutions = json.educational_institutions.map((institution) => {
          return [
            institution.id,
            (0,_tools__WEBPACK_IMPORTED_MODULE_1__.dateCell)(institution.start_date),
            (0,_tools__WEBPACK_IMPORTED_MODULE_1__.dateCell)(institution.end_date),
            institution.type,
            institution.city,
            institution.street,
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */var _educational_institution_overview_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./educational_institution_overview/index.js */ "./js/educational_institution_overview/index.js");


const educationalInstitutionOverview = new _educational_institution_overview_index_js__WEBPACK_IMPORTED_MODULE_0__.EducationalInstitutionOverview()
educationalInstitutionOverview.init()

})()
;
//# sourceMappingURL=educational_institution_overview.js.map