...
"./js/home/address.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class Address {
  ...
  getAddresses() {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_0__.getJson)(`/api/address/get_current/${this.copsacId}/`).then(
...
"./js/home/base_info.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  BaseInfo: function() { return BaseInfo; }
});
/* harmony import */var _tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../tools */ "./js/tools/index.js");
...
class BaseInfo {
  ...
  getProband() {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_0__.getJson)(`/api/get_proband/${this.copsacId}/`).then(({ json }) => {
      if (!json.proband) {
...
"./js/home/consent.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
class Consent {
  ...
  getData() {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getJson)(`/api/get_missing_consents/${this.copsacId}/`).then(
      ({ json }) => {
        return json["consents"].map((consent) => {
          return [
            consent.id,
            consent.name,
            (0,_tools__WEBPACK_IMPORTED_MODULE_1__.dateCell)(consent.date),
            consent.status,
          ]
        })
      },
  ...
  renderData(consents) {
    ...
    this.table = new simple_datatables__WEBPACK_IMPORTED_MODULE_0__.DataTable(this.el.lastElementChild, {
      data: {
        headings: [
          "ID",
  ...
  bind() {
    ...
    new _tools__WEBPACK_IMPORTED_MODULE_1__.ContextMenu(this.el, menuItems, {
      show: (event) => {
        const tr = event.target.closest("tr")
        if (!tr) {
          return false
...
"./js/home/diagnosis.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
class Diagnosis {
  ...
  getData() {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getJson)(`/api/diagnosis/get/${this.copsacId}/`).then(({ json }) => {
      return json.diagnoses.map((diagnosis) => [
        diagnosis.id,
        diagnosis.lock_status,
        diagnosis.icd_code__description,
        diagnosis.icd_code__code,
        (0,_tools__WEBPACK_IMPORTED_MODULE_1__.dateCell)(diagnosis.start_date),
        (0,_tools__WEBPACK_IMPORTED_MODULE_1__.dateCell)(diagnosis.end_date),
      ])
    })
  }
  ...
  lockRow(id) {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.get)(`/api/diagnosis/lock/${this.copsacId}/${id}/`).then(() => {
  ...
  deleteData(id) {
    ...
    if (
      ...
      return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.get)(`/api/diagnosis/delete/${this.copsacId}/${id}/`).then(
        ({ status, redirected }) => {
...
"./js/home/index.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  Home: function() { return Home; }
});
/* harmony import */var _tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../tools */ "./js/tools/index.js");
/* harmony import */var _address__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./address */ "./js/home/address.js");
/* harmony import */var _base_info__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./base_info */ "./js/home/base_info.js");
/* harmony import */var _institution__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./institution */ "./js/home/institution.js");
/* harmony import */var _diagnosis__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./diagnosis */ "./js/home/diagnosis.js");
/* harmony import */var _medication__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./medication */ "./js/home/medication.js");
/* harmony import */var _consent__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./consent */ "./js/home/consent.js");
/* harmony import */var _note__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./note */ "./js/home/note.js");
/* harmony import */var _relatives__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./relatives */ "./js/home/relatives.js");
/* harmony import */var _reminder__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./reminder */ "./js/home/reminder.js");
/* harmony import */var _visits_examinations_cells__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./visits_examinations_cells */ "./js/home/visits_examinations_cells.js");
...
class Home {
  ...
  init() {
    return Promise.all([
      ...
      (0,_tools__WEBPACK_IMPORTED_MODULE_0__.getJson)(`/api/get_probands/`).then(({ json }) => {
  ...
  bind() {
    document.querySelector("#id_logout").addEventListener("click", (event) => {
      event.preventDefault()
      return (0,_tools__WEBPACK_IMPORTED_MODULE_0__.get)("/api/logout_user/").then(() => (window.location = "/"))
    })
  ...
  whenReady() {
    (0,_tools__WEBPACK_IMPORTED_MODULE_0__.autocomplete)(document.querySelector("#probands"), this.probands)

    if (this.copsacId) {
      const baseInfo = new _base_info__WEBPACK_IMPORTED_MODULE_2__.BaseInfo(
        document.querySelector("#base-info"),
        document.body,
        this.copsacId,
      )
      const address = new _address__WEBPACK_IMPORTED_MODULE_1__.Address(
        document.querySelector("#address"),
        this.copsacId,
      )
      address.init()
      baseInfo.init()
      const institution = new _institution__WEBPACK_IMPORTED_MODULE_3__.Institution(
        document.querySelector("#institution"),
        this.copsacId,
      )
      institution.init()
      const consent = new _consent__WEBPACK_IMPORTED_MODULE_6__.Consent(
        document.querySelector("#consent"),
        this.copsacId,
      )
      consent.init()
      const diagnosis = new _diagnosis__WEBPACK_IMPORTED_MODULE_4__.Diagnosis(
        document.querySelector("#diagnosis"),
        this.copsacId,
      )
      diagnosis.init()

      const medication = new _medication__WEBPACK_IMPORTED_MODULE_5__.Medication(
        document.querySelector("#medication"),
        this.copsacId,
      )
      medication.init()

      const relatives = new _relatives__WEBPACK_IMPORTED_MODULE_8__.Relatives(
        document.querySelector("#relatives"),
        this.copsacId,
      )
      relatives.init()

      const reminder = new _reminder__WEBPACK_IMPORTED_MODULE_9__.Reminder(
        document.querySelector("#reminder"),
        this.copsacId,
      )
      reminder.init()

      const notes = new _note__WEBPACK_IMPORTED_MODULE_7__.Note(document.querySelector("#notes"), this.copsacId)
      notes.init()

      const visitsExaminationsCells = new _visits_examinations_cells__WEBPACK_IMPORTED_MODULE_10__.VisitsExaminationsCells(
...
"./js/home/institution.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  Institution: function() { return Institution; }
});
/* harmony import */var _tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../tools */ "./js/tools/index.js");
...
class Institution {
  ...
  getInstitutions() {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_0__.getJson)(
...
"./js/home/medication.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  Medication: function() { return Medication; }
});
/* harmony import */var simple_datatables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! simple-datatables */ "./node_modules/.pnpm/simple-datatables@9.1.0/node_modules/simple-datatables/dist/module.js");
/* harmony import */var _tools__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../tools */ "./js/tools/index.js");
...
class Medication {
  ...
  getData() {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getJson)(`/api/medication/get/${this.copsacId}/`).then(({ json }) => {
      ...
      this.medications = json.medications.map((medication) => ({
        cells: [
          ...
          (0,_tools__WEBPACK_IMPORTED_MODULE_1__.dateCell)(medication.start_date),
          (0,_tools__WEBPACK_IMPORTED_MODULE_1__.dateCell)(medication.end_date),
          {
    ...
    const createEmptyVaccineRow = (name, code, date) => {
      return {
        cells: [
          ...
          (0,_tools__WEBPACK_IMPORTED_MODULE_1__.dateCell)(),
          { data: " " },
        ],
      }
    }
  ...
  lockRow(id) {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.get)(`/api/medication/lock/${this.copsacId}/${id}/`).then(() => {
      const index = this.table.data.data.findIndex(
        (row) => row.cells[0].data === id,
      )
  ...
  deleteData(id) {
    ...
    if (
      ...
      return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.get)(`/api/medication/delete/${this.copsacId}/${id}/`).then(
        ({ status, redirected }) => {
          if (status === 200 && !redirected) {
...
"./js/home/note.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
...
function dateHTMLReadonly(date) {
  return `<b>${(0,_tools__WEBPACK_IMPORTED_MODULE_1__.renderDate)(date)}</b>`
}
...
class Note {
  ...
  getNotes() {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getJson)(`/api/get_notes/${this.copsacId}/`).then(({ json }) => {
    ...
    outHTML += this.notes
      .map(
        (note) => `<div class="note disabled"><span class="date" data-date="${
          ...
          <textarea data-note-id="${note.id}" readonly>${(0,_tools__WEBPACK_IMPORTED_MODULE_1__.escapeText)(
            note.note,
          )}</textarea>
          <div class="mx-1 my-2">
            <button class="btn btn-sm btn-primary save">Save</button>
    ...
    this.el.addEventListener("click", (event) => {
      ...
      if (event.target.closest("button.edit-note")) {
        ...
        if (textarea.hasAttribute("readonly")) {
          ...
          const fEl = (0,flatpickr__WEBPACK_IMPORTED_MODULE_0__["default"])(noteDateDiv.firstElementChild, {
            altFormat: "d-m-Y",
            altInput: true,
            allowInput: true,
            ...
            parseDate: _tools__WEBPACK_IMPORTED_MODULE_1__.parseDate,
  ...
  updateNote(noteId, noteText, noteDate = false) {
    ...
    return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.postJson)(
...
"./js/home/relatives.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  Relatives: function() { return Relatives; }
});
/* harmony import */var simple_datatables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! simple-datatables */ "./node_modules/.pnpm/simple-datatables@9.1.0/node_modules/simple-datatables/dist/module.js");
/* harmony import */var _tools__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../tools */ "./js/tools/index.js");
...
class Relatives {
  ...
  getData() {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getJson)(`/api/get_relatives/${this.copsacId}/`).then(({ json }) => {
      return json.relatives.map((row) =>
        row.map((cell, index) => {
          if (index !== 4) {
            return cell
          }
          return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.dateCell)(cell)
        }),
      )
    })
  }
  ...
  deleteData(id) {
    ...
    if (
      ...
      return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.get)(`/api/delete_relative/${id}/`).then(() => {
        const index = this.table.data.data.findIndex(
          (row) => row.cells[0]?.data === id,
        )
        if (index > -1) {
...
"./js/home/reminder.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  Reminder: function() { return Reminder; }
});
/* harmony import */var _tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../tools */ "./js/tools/index.js");
...
class Reminder {
  ...
  getReminder() {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_0__.getJson)(`/api/get_reminder/${this.copsacId}/`).then(({ json }) => {
      if (json.reminder) {
  ...
  render() {
    const outHTML = `<h4>Reminder: <button class="edit">Edit</button></h4>
      <div class="reminder disabled">
        <textarea placeholder="Currently no reminders for this proband" readonly>${(0,_tools__WEBPACK_IMPORTED_MODULE_0__.escapeText)(
          this.value,
        )}</textarea>
        <div class="mx-1 my-2">
          <button class="btn btn-sm btn-primary save">Save</button>
  ...
  updateReminder(text) {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_0__.post)(`/api/save_reminder/${this.copsacId}/`, {
      value: text,
    }).then(() => {
      this.value = text
    })
...
"./js/home/visits_examinations_cells.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  VisitsExaminationsCells: function() { return VisitsExaminationsCells; }
});
/* harmony import */var simple_datatables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! simple-datatables */ "./node_modules/.pnpm/simple-datatables@9.1.0/node_modules/simple-datatables/dist/module.js");
/* harmony import */var _tools__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../tools */ "./js/tools/index.js");
...
class VisitsExaminationsCells {
  ...
  getVisits() {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getJson)(`/api/get_visits/${this.copsacId}/`).then(({ json }) => {
  ...
  getExaminations() {
    ...
    return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getJson)(`/api/get_examinations/${this.selectedVisitId}/`).then(
      ({ json }) =>
  ...
  getCells() {
    ...
    return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getJson)(
  ...
  renderVisits(visits) {
    ...
    this.visitsTable = new simple_datatables__WEBPACK_IMPORTED_MODULE_0__.DataTable(this.visitsEl.lastElementChild, {
      type: "string",
      data: {
        headings: [
          "ID",
  ...
  renderExaminations(examinations) {
    ...
    this.examinationsTable = new simple_datatables__WEBPACK_IMPORTED_MODULE_0__.DataTable(
  ...
  renderCells(cells) {
    ...
    this.cellsTable = new simple_datatables__WEBPACK_IMPORTED_MODULE_0__.DataTable(this.cellsEl.lastElementChild, {
      type: "string",
      data: cells,
      searchable: false,
      fixedHeight: false,
  ...
  deleteVisit(id) {
    ...
    if (
      ...
      return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.get)(`/api/delete_visit/${id}/`).then(() => {
  ...
  lockExaminationRow(tr) {
    ...
    return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.get)(`/api/lock_examination/${String(id)}/`).then(() => {
  ...
  deleteExamination(id) {
    ...
    if (
      ...
      return (0,_tools__WEBPACK_IMPORTED_MODULE_1__.get)(`/api/delete_examination/${id}/`).then(() => {
        const examinationIndex = this.examinationsTable.data.data.findIndex(
          (row) => row.cells[1].data === id,
        )
  ...
  bind() {
    ...
    new _tools__WEBPACK_IMPORTED_MODULE_1__.ContextMenu(this.visitsEl, visitMenuItems, {
      show: (event) => {
        const tr = event.target.closest("tr[data-index]")
        if (!tr) {
          return false
    ...
    new _tools__WEBPACK_IMPORTED_MODULE_1__.ContextMenu(this.examinationsEl, examinationMenuItems, {
      show: (event) => {
        const tr = event.target.closest("tr[data-index]")
        if (!tr) {
          return false
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */var _home_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./home/index.js */ "./js/home/index.js");


const home = new _home_index_js__WEBPACK_IMPORTED_MODULE_0__.Home()
home.init()
