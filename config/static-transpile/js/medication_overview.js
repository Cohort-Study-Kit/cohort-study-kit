...
"./js/medication_overview/index.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  MedicationOverview: function() { return MedicationOverview; }
});
...
class MedicationOverview {
  ...
  getDiagnoses() {
    return (0,_tools_index_js__WEBPACK_IMPORTED_MODULE_1__.getJson)(`/api/medication/get/${this.copsacId}/`).then(({ json }) => {
      this.medications = json.medications.map((medication) => {
        return [
          medication.id,
          (0,_tools_index_js__WEBPACK_IMPORTED_MODULE_1__.dateCell)(medication.start_date),
          (0,_tools_index_js__WEBPACK_IMPORTED_MODULE_1__.dateCell)(medication.end_date),
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */var _medication_overview_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./medication_overview/index.js */ "./js/medication_overview/index.js");


const medicationOverview = new _medication_overview_index_js__WEBPACK_IMPORTED_MODULE_0__.MedicationOverview()
medicationOverview.init()

})()
;
//# sourceMappingURL=medication_overview.js.map