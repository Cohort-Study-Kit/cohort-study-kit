...
"./js/diagnosis_overview/index.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  DiagnosisOverview: function() { return DiagnosisOverview; }
});
...
class DiagnosisOverview {
  ...
  getDiagnoses() {
    return (0,_tools_index_js__WEBPACK_IMPORTED_MODULE_1__.getJson)(`/api/diagnosis/get/${this.copsacId}/`).then(({ json }) => {
      this.diagnoses = json.diagnoses.map((diagnosis) => {
        return [
          diagnosis.id,
          (0,_tools_index_js__WEBPACK_IMPORTED_MODULE_1__.dateCell)(diagnosis.start_date),
          (0,_tools_index_js__WEBPACK_IMPORTED_MODULE_1__.dateCell)(diagnosis.end_date),
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */var _diagnosis_overview_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./diagnosis_overview/index.js */ "./js/diagnosis_overview/index.js");


const diagnosisOverview = new _diagnosis_overview_index_js__WEBPACK_IMPORTED_MODULE_0__.DiagnosisOverview()
diagnosisOverview.init()

})()
;
//# sourceMappingURL=diagnosis_overview.js.map