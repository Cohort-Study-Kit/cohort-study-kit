...
"./js/medication_view/index.js": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  MedicationView: function() { return MedicationView; }
});
...
class MedicationView {
  ...
  bind() {
    ...
    this.choice = new choices_js__WEBPACK_IMPORTED_MODULE_1__["default"](atcCodeSelector, {
      allowHTML: false,
    ...
    if (deleteButton) {
      ...
      deleteButton.addEventListener("click", () => {
        if (confirm(`Do you really want to delete this medication?`)) {
          return (0,_tools__WEBPACK_IMPORTED_MODULE_0__.get)(`/api/medication/delete/${this.copsacId}/${id}/`).then(
            ({ status, redirected }) => {
  ...
  lookUp(term) {
    return (0,_tools__WEBPACK_IMPORTED_MODULE_0__.getJson)(`/api/atc_code/search/${encodeURIComponent(term)}/`).then(
      ({ json }) =>
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */var _medication_view_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./medication_view/index.js */ "./js/medication_view/index.js");


const medicationView = new _medication_view_index_js__WEBPACK_IMPORTED_MODULE_0__.MedicationView()
medicationView.init()

})()
;
//# sourceMappingURL=medication_view.js.map